...
Partial Public Class BdCentroMedicoEntities
    ...
    Public Overridable Function sp_BuscarPersonal(cedu As String) As ObjectResult(Of sp_BuscarPersonal_Result)
        Dim ceduParameter As ObjectParameter = If(cedu IsNot Nothing, New ObjectParameter("Cedu", cedu), New ObjectParameter("Cedu", GetType(String)))

        Return DirectCast(Me, IObjectContextAdapter).ObjectContext.ExecuteFunction(Of sp_BuscarPersonal_Result)("sp_BuscarPersonal", ceduParameter)
    End Function
