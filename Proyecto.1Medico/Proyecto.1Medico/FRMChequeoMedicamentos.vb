Public Class FRMChequeoMedicamentos
    Dim registro As New Medicamentos()
    ...
    Private Sub FRMChequeoMedicamentos_Load(sender As Object, e As EventArgs) Handles MyBase.Load
